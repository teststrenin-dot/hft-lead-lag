...
6. **MVP-first, no premature hardening**  
   До готовности MVP не добавляем защитные механизмы и усложнения "на будущее".  
   Архитектуру "впрок" не строим: реализуем только то, что нужно текущему MVP и подтверждено задачами.
