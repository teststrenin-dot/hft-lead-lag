...
| `HFT-CP5` Deterministic Replay Harness | `In Progress` | Raw feed recorder + replay mode + decision equivalence checks | Block 1 done: JSONL raw-feed recorder and strict replay reader with sequence/payload validation (`2026-02-28-cp5-block1-raw-feed-evidence.md`); next: runtime capture wiring + decision equivalence checks |
